      ...
      <div className="max-w-7xl mx-auto px-4 py-8 flex flex-col gap-8">
        ...
        <div className="flex flex-col md:flex-row gap-6 items-start">
          ...
          <div className="hidden md:flex w-64 bg-blue-50 rounded-xl items-center justify-center border border-blue-100 shadow-sm sticky top-4 h-[calc(100vh-2rem)] shrink-0">
            ...
            src="starters.jpg" 
            alt="" 
            className='absolute inset-0w-full h-full object-cover'
            />
          </div>

          <div className="flex-1 flex flex-col bg-white rounded-xl shadow-sm border border-gray-100 relative min-w-0">
             <PokemonGrid />
          </div>

          <div className="hidden md:flex w-64 bg-blue-50 rounded-xl items-center justify-center border border-blue-100 shadow-sm sticky top-4 h-[calc(100vh-2rem)]">
            <img 
            src="ash.jpg" 
            alt="" 
